  ...
  return (
    <div className='confirm-booking-page'>
      <div className='confirm-booking-page__summary'>
        ...
        <h2>Map Link</h2>
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31114.24135837003!2d77.56056525878716!3d12.8896976182102!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae150d7349a72b%3A0xf3d03ea1e1dd3d46!2sJ.%20P.%20Nagar%2C%20Bengaluru%2C%20Karnataka%20560078!5e0!3m2!1sen!2sin!4v1678966528913!5m2!1sen!2sin" height="450" allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"
        title='Map'></iframe>
      </div>

      <div className='confirm-booking-page__content'>
        <h1>Kindly confirm your booking details</h1>
        <Button className='proceed-to-payment__btn'><Link to="/booking-successful">Complete booking process</Link></Button>
      </div>
    </div>
  )
}
